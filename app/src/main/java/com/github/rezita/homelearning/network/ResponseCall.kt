...
class ResponseCall<T>(val delegate: Call<T>) : Call<Result<T>> {
        ...
        delegate.enqueue(object : Callback<T> {
            ...
            override fun onFailure(call: Call<T>, t: Throwable) {
                val errorMessage = when (t) {
                    ...
                    is HttpException -> "Something went wrong during the request!"
                    is RuntimeException -> "Something went wrong after receiving the data."
